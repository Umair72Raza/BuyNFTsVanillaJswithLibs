// available in Umair's google account with the name Console marketPlace in Remix IDE
...
contract BuyNFT is ERC1155, Ownable {
    ...
    function mintNFT(address to, uint256 id, uint256 amount) external onlyOwner {
        _mint(to, id, amount, "");
    }
